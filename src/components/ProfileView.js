                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="bg-white p-4 rounded-2xl shadow-inner border border-slate-100 mb-6 flex justify-center">
                                                <img
                                                    src={`https://api.qrserver.com/v1/create-qr-code/?size=256x256&color=0f172a&bgcolor=ffffff&data=${encodeURIComponent('https://boond-sand.vercel.app/profile/' + profile.username.replace('@', ''))}`}
                                                    alt="Profile QR Code"
                                            ...
                                            <p className="font-mono text-xs text-slate-400 bg-slate-50 px-3 py-1 rounded-full">
                                                boond-sand.vercel.app/profile/{profile.username.replace('@', '')}
                                            </p>
                                        </motion.div>
                                    </motion.div>
                                )}
                            ...
                            <div className="space-y-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-red-500 font-bold mt-1 ml-1 leading-tight">
                                        {lang === 'id'
                                            ? '*Username wajib unik sebagai alamat link profilmu (boond.vercel.app/u/username)'
                                            : '*Username must be unique as it serves as your profile link (boond.vercel.app/u/username)'}
                                    </p>
                                </div>
                                <div>
